...
export const NewUserSchema = Yup.object().shape({
  ...
  email: Yup.string().required('Vui lòng không để trống email'),
  ...
  roleId: Yup.object().shape({
    name: Yup.string().required('Vai trò không được trống'),
    id: Yup.number().required('Vai trò không được trống'),
  }),
});
